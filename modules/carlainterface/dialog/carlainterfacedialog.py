...
class CarlaInterfaceDialog(JoanModuleDialog):
    ...
    def __init__(self, module_action: JoanModuleAction, parent=None):
        ...
        self.module_widget.btn_add_ego_agent.clicked.connect(self.module_action.add_ego_agent)
        self.module_widget.btn_add_traffic_agent.clicked.connect(self.module_action.add_traffic_agent)
        ...
        self.module_widget.btnDisconnect.clicked.connect(self.module_action.disconnect)
