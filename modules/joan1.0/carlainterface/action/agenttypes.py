...
class AgentTypes(enum.Enum):
    ...
    def settings_ui_file(self):
        ...
        return {AgentTypes.EGOVEHICLE: os.path.join(path_to_uis, "ego_vehicle_settings_ui.ui"),
                AgentTypes.TRAFFICVEHICLE: os.path.join(path_to_uis, "traffic_vehicle_settings_ui.ui")}[self]

    @property
    def agent_tab_ui_file(self):
        path_to_uis = os.path.join(os.path.dirname(os.path.realpath(__file__)), "../dialog/ui/")
        return {AgentTypes.EGOVEHICLE: os.path.join(path_to_uis, "ego_vehicle_tab.ui"),
                AgentTypes.TRAFFICVEHICLE: os.path.join(path_to_uis, "traffic_vehicle_tab.ui")}[self]
