...
class JoanHQWindow(QtWidgets.QMainWindow):
    ...
    def add_module(self, module_widget):
        ...
        if isinstance(module_widget, (JOANModules.TEMPLATE.dialog, JOANModules.DATA_RECORDER.dialog, JOANModules.EXPERIMENT_MANAGER.dialog)):  # syntax is changed slightly in new example: wrapping show() in _show() is unnecessary
